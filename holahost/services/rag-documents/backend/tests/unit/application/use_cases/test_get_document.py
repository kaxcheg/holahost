"""Tests for GetDocumentUseCase (UC-R4)."""
...
from tests._support.fakes import FakeDocumentsRepo
...
class TestGetDocumentUseCase:
    def test_returns_document_view(self) -> None:
        ...
        uc = GetDocumentUseCase(documents_repo=FakeDocumentsRepo([existing]))
    ...
    def test_missing_document_raises_not_found(self) -> None:
        uc = GetDocumentUseCase(documents_repo=FakeDocumentsRepo())
