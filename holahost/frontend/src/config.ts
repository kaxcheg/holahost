 ...
 * `services/lead-capture/envs/<env>.env` (single source of truth, shared with the backend). Values are baked at
...
/** Current deployment environment (from `services/lead-capture/envs/<env>.env` via Vite). */
